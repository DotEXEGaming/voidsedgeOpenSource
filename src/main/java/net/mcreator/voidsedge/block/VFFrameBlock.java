...
public class VFFrameBlock extends VoidsEdgeModElements.ModElement {
	@ObjectHolder("voids_edge:vf_frame")
	public static final Block block = null;

	public VFFrameBlock(VoidsEdgeModElements instance) {
		super(instance, 3);
	}
