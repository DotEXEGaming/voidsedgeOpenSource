...
public class VFCoreBlock extends VoidsEdgeModElements.ModElement {
	@ObjectHolder("voids_edge:vf_core")
	public static final Block block = null;

	public VFCoreBlock(VoidsEdgeModElements instance) {
		super(instance, 2);
	}
